...
contract GlobalVariables {
        ...
        )
    {
        ...
        uint256 timestamp = block.timestamp; // this stores the unix time stamp of when this fn was called
        // datatype of uint timestamp is uint

        uint256 blockNum = block.number; // this stores the current block number, datatype is uint
